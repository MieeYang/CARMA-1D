...
NUCGROWTEST.exe : $(CARMA_OBJ) carma_nuc_grow.o carma_testutils.o atmosphere_mod.o clima_mod.o
	$(FORTRAN) $(LDFLAGS) -o NUCGROW.exe carma_nuc_grow.o carma_testutils.o atmosphere_mod.o clima_mod.o $(CARMA_OBJ)
